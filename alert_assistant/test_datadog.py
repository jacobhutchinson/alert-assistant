...
query2 = "avg:kubernetes.cpu.requests{kube_cluster_name:de-prd-use1-001,kube_container_name:salesforce-data-extensions} by {container_name,kube_deployment,service,kube_namespace,kube_cluster_name}"
